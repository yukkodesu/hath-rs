        ...
        match setting.as_str() {
            ...
            "rpc_server_ip" => {
                self.rpc_servers = value
                    ...
                    .collect();
                // RPC routing state lives inside RpcClient; changing rpc_server_ip
                // only updates this settings snapshot.
            }
